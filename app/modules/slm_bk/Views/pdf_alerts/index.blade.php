    ...
    <div class="col-sm-12">
        <div class="panel">
            <div class="panel-heading">
                ...
                @if($role_id == 1)
                <a class="btn btn-primary btn-xs pull-right" href="{{ route('pdf-alert') }}" data-placement="top" data-content="click add new Alert">
                            ...
                            @foreach($data as $values)
                                <tr class="gradeX">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('edit-alert', $values->id) }}" class="btn btn-primary btn-xs" data-placement="top" data-content="update"><i class="fa fa-edit"></i></a>
