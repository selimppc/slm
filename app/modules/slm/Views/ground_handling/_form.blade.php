        ...
        <div class="col-md-6" style="padding: 0px;">
            @if(isset(Auth::user()->role_id))
                ...
                @if(Auth::user()->role_id == 1 && @$ground_handling_verification->reference_no != null && @$ground_handling_verification->sent_receive == 0)
                    <a href="{{ route('ground-sent-receive', $ground_handling_verification->id) }}" class="btn btn-info btn-xs glyphicon glyphicon-envelope" data-placement="top" data-toggle="modal" title="Send Email" data-target="#etsbModal"></a>
                @endif
...
<div class="row">
    <div class="col-sm-4">
        ...
        {!! Form::text('full_name', $ground_handling_verification->full_name, ['id'=>'full_name', 'class' => 'form-control','maxlength'=>'64','title'=>'enter full name','readonly']) !!}
    </div>
    <div class="col-sm-4">
        {!! Form::label('email', 'Email Address:', ['class' => 'control-label']) !!}
        <small class="required">(Required)</small>
        {!! Form::email('email',$ground_handling_verification->email,['maxlength'=>256,'class' => 'form-control','placeholder'=>'Email Address','required', 'title'=>'Enter User Email Address','readonly']) !!}

    </div>
    <div class="col-sm-4">
        {!! Form::label('telephone', 'Telephone No:', ['class' => 'control-label']) !!}
        {!! Form::text('telephone', $ground_handling_verification->telephone, ['id'=>'telephone', 'class' => 'form-control','maxlength'=>'64','title'=>'enter full name','readonly']) !!}
