    ...
    <div class="col-sm-12">
        <div class="panel">
            <div class="panel-heading">
                ...
                <a class="btn btn-primary btn-xs pull-right csv-margin" href="{{ route('add-ground-handling') }}" data-placement="top" data-content="Click to add new Ground Handling report">
                ...
                <div class="col-md-6 buttons-div">
                    <a class="btn btn-primary btn-xs margin-bot-5" href="{{ route('add-ground-handling') }}" data-placement="top" data-content="Click to add new Ground Handling report">
                        <strong>Add new Ground Handling report</strong>
                    </a>
                    <a href="{{ route('ground-csv') }}" class="btn btn-info btn-xs margin-bot-5" data-placement="top"><strong>Download CSV</strong></a>
                    <div class="padding-tb"></div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="table-primary">
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered ml-table-ghr" id="jq-datatables-example">
                            ...
                            @if(isset($ground_handling))
                                @foreach($ground_handling as $values)
                                    <tr class="gradeX">
                                        ...
                                        <td>
                                            ...
                                            @if(count($values->relGroundHandling)>0)
                    ...
                    <span class="pull-left">{!! str_replace('/?', '?', $ground_handling->appends(Input::except('page'))->render()) !!} </span>
                </div>
            </div>
        </div>
    </div>
