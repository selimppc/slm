...
@section('content')
    ...
    <div class="panel">
        ...
        <div style="padding-right: 15px" class="buttons-div">
            <a href="{{ route('dangerous-pdf', $operational_safety->id) }}" class="btn btn-primary margitn-bot-5"><strong>Export PDF</strong></a>
        </div>
        ...
        <div class="panel-body">
            ...
            <table class="table table-bordered table-responsive report" width="100%">
                <tr>
                    ...
                    <th width="100%" colspan="1" style="border: 2px solid; text-align:left; vertical-align: top;"> Safety Department <br> ref. nr : {{ $operational_safety->reference_no }}</th>
                </tr>
                <tr>
