{!! Form::model($data, ['method' => 'PATCH', 'route'=> ['update-operational-sendreceive', $data], 'files'=>true]) !!}
...
<div class="modal-footer">
    ...
    <a href="{{route('operational-safety')}}" class=" btn btn-default" data-placement="top" data-content="click close button for close this entry form">Close</a>
</div>
