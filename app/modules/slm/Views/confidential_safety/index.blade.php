    ...
    <div class="col-sm-12">
        <div class="panel">
            <div class="panel-heading">
                ...
                <a class="btn btn-primary btn-xs pull-right" href="{{ route('add-confidential-safety') }}" data-placement="top" data-content="Click to add new Confidential Safety report">
                        ...
                        @if(isset($confidential_safety))
                            @foreach($confidential_safety as $values)
                                <tr class="gradeX">
                                    ...
                                    <td>
                                        <a href="{{ route('view-confidential-safety', $values->id) }}" class="btn btn-info btn-xs" data-placement="top" data-content="view"><i class="fa fa-eye"></i></a>
                                        <a href="{{ route('edit-confidential-safety', $values->id) }}" class="btn btn-primary btn-xs" data-placement="top" data-content="update"><i class="fa fa-edit"></i></a>
                                        <a href="{{ route('delete-confidential-safety', $values->id) }}" class="btn btn-danger btn-xs" data-placement="top" onclick="return confirm('Are you sure to Delete?')" data-content="delete"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        @endif
