    ...
    function _encodeUTF16($string) {
        ...
        if ($this->_defaultEncoding){
            switch ($this->_encoderFunction){
                case 'iconv' :   $result = iconv(mb_detect_encoding($string, mb_detect_order(), false), "UTF-8//IGNORE", $string); //iconv('UTF-16LE', $this->_defaultEncoding, $string);
                    break;
